...
2. **Make _ir_generated.py hand-maintained** for the 4 core node types. Pro: simple. Con: breaks the fully-automated codegen story.
3. **Use class inheritance** — generate base nodes, hand-write v5 extensions as subclasses. Pro: clean separation. Con: type union gets complex.
