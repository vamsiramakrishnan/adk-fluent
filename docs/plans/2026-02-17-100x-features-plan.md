...
1. Applies renames from `[renames]` section
1. Appends manual extras to the corresponding builder's extras list
1. Preserves any manual aliases not generated by the alias engine
...
**Step 3: Implement with\_() in BuilderBase**
