...
analytics_pipeline = (
    Agent("metric_calculator").model("gemini-2.5-flash")
    ...
    >> Agent("dashboard_generator").model("gemini-2.5-flash")
...
validated_pipeline = (
    Agent("data_ingester").model("gemini-2.5-flash")
    ...
    >> Agent("aggregator").model("gemini-2.5-flash")
    ...
    >> Agent("report_builder").model("gemini-2.5-flash")
