...
# Demonstrates tap, expect, gate, Route, S.*, and sub_agent working together
# in a realistic e-commerce order processing system. Complements
# 34_full_algebra.py which covers the operator primitives (>>, |, *, @, //).
