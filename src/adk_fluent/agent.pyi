...
Timestamp: 2026-02-20T06:36:27.781118+00:00"""
...
class Agent(BuilderBase):
    ...
    _ADDITIVE_FIELDS: set[str] = {'before_model_callback', 'after_model_callback', 'before_agent_callback', 'after_tool_callback', 'on_model_error_callback', 'after_agent_callback', 'on_tool_error_callback', 'before_tool_callback'}
