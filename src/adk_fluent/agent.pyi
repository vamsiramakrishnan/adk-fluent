...
Timestamp: 2026-02-20T05:48:32.357971+00:00"""
...
class Agent(BuilderBase):
    ...
    _ADDITIVE_FIELDS: set[str] = {'on_tool_error_callback', 'on_model_error_callback', 'before_tool_callback', 'after_agent_callback', 'before_model_callback', 'before_agent_callback', 'after_tool_callback', 'after_model_callback'}
