...
Timestamp: 2026-02-20T05:48:32.356117+00:00"""
...
class BigQueryLoggerConfig(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'shutdown_timeout', 'event_denylist', 'enabled', 'event_allowlist', 'log_session_metadata', 'queue_max_size', 'content_formatter', 'connection_id', 'batch_flush_interval', 'max_content_length', 'batch_size', 'custom_tags', 'retry_config', 'log_multi_modal_content', 'table_id', 'gcs_bucket_name', 'clustering_fields'}
    def __init__(self) -> None: ...
