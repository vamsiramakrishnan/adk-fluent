...
Timestamp: 2026-02-20T06:36:27.778177+00:00"""
...
class BigQueryLoggerConfig(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'connection_id', 'log_session_metadata', 'custom_tags', 'retry_config', 'gcs_bucket_name', 'shutdown_timeout', 'clustering_fields', 'queue_max_size', 'enabled', 'event_allowlist', 'batch_flush_interval', 'max_content_length', 'content_formatter', 'table_id', 'log_multi_modal_content', 'batch_size', 'event_denylist'}
    def __init__(self) -> None: ...
