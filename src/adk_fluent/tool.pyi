...
Timestamp: 2026-02-20T06:36:27.775978+00:00"""
...
class APIHubToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'auth_scheme', 'access_token', 'name', 'auth_credential', 'description', 'lazy_load_spec', 'apihub_client', 'apihub_resource_name', 'service_account_json', 'tool_filter'}
...
class ApplicationIntegrationToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'project', 'connection', 'auth_scheme', 'integration', 'actions', 'tool_name_prefix', 'auth_credential', 'location', 'service_account_json', 'triggers', 'tool_instructions', 'connection_template_override', 'entity_operations', 'tool_filter'}
...
class IntegrationConnectorTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'auth_scheme', 'entity', 'name', 'auth_credential', 'description', 'operation', 'action', 'connection_name', 'rest_api_tool', 'connection_service_name', 'connection_host'}
...
class BaseAuthenticatedTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'auth_config', 'response_for_auth_required', 'name', 'description'}
...
class DiscoveryEngineSearchTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'max_results', 'data_store_id', 'data_store_specs', 'filter', 'search_engine_id'}
    def __init__(self) -> None: ...
...
class GoogleApiToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'api_version', 'client_id', 'client_secret', 'tool_filter', 'api_name', 'tool_name_prefix', 'additional_headers', 'service_account'}
...
class GoogleTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'func', 'tool_settings', 'credentials_config'}
    def __init__(self, func: str) -> None: ...
...
class McpTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'auth_scheme', 'mcp_session_manager', 'mcp_tool', 'header_provider', 'require_confirmation', 'auth_credential', 'progress_callback'}
...
class McpToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'auth_scheme', 'header_provider', 'connection_params', 'errlog', 'auth_credential', 'require_confirmation', 'tool_name_prefix', 'progress_callback', 'use_mcp_resources', 'tool_filter'}
...
class OpenAPIToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'auth_scheme', 'spec_str_type', 'header_provider', 'spec_dict', 'tool_name_prefix', 'auth_credential', 'ssl_verify', 'credential_key', 'spec_str', 'tool_filter'}
    def __init__(self) -> None: ...
...
class RestApiTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'endpoint', 'auth_scheme', 'name', 'header_provider', 'auth_credential', 'description', 'ssl_verify', 'operation', 'credential_key', 'should_parse_operation'}
...
class ToolboxToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'bound_params', 'auth_token_getters', 'tool_names', 'toolset_name', 'credentials', 'server_url', 'additional_headers'}
...
class VertexAiSearchTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'bypass_multi_tools_limit', 'max_results', 'data_store_id', 'data_store_specs', 'filter', 'search_engine_id'}
    def __init__(self) -> None: ...
    def data_store_id(self, value: Optional[str]) -> Self: ...
    def data_store_specs(self, value: Optional[list[types.VertexAISearchDataStoreSpec]]) -> Self: ...
    def search_engine_id(self, value: Optional[str]) -> Self: ...
