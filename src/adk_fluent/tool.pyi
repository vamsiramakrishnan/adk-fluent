...
Timestamp: 2026-02-20T05:35:25.152123+00:00"""
...
class APIHubToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'lazy_load_spec', 'apihub_client', 'description', 'auth_credential', 'apihub_resource_name', 'name', 'auth_scheme', 'service_account_json', 'access_token', 'tool_filter'}
...
class ApplicationIntegrationToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'tool_instructions', 'project', 'triggers', 'auth_credential', 'location', 'entity_operations', 'actions', 'tool_name_prefix', 'integration', 'auth_scheme', 'service_account_json', 'connection_template_override', 'connection', 'tool_filter'}
...
class IntegrationConnectorTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'entity', 'description', 'auth_credential', 'connection_host', 'connection_service_name', 'connection_name', 'action', 'name', 'auth_scheme', 'operation', 'rest_api_tool'}
...
class BaseAuthenticatedTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'response_for_auth_required', 'name', 'description', 'auth_config'}
...
class BaseTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'is_long_running', 'custom_metadata', 'name', 'description'}
    def __init__(self, name: str, description: str) -> None: ...
...
class DiscoveryEngineSearchTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'filter', 'search_engine_id', 'data_store_specs', 'data_store_id', 'max_results'}
    def __init__(self) -> None: ...
...
class GoogleApiTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'client_id', 'service_account', 'additional_headers', 'rest_api_tool', 'client_secret'}
...
class GoogleApiToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'api_name', 'client_id', 'service_account', 'api_version', 'additional_headers', 'tool_name_prefix', 'client_secret', 'tool_filter'}
...
class CalendarToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'client_id', 'service_account', 'tool_name_prefix', 'client_secret', 'tool_filter'}
    def __init__(self) -> None: ...
    def client_id(self, value: Optional[str]) -> Self: ...
    def client_secret(self, value: Optional[str]) -> Self: ...
    def tool_filter(self, value: Optional[Union[ToolPredicate, List[str]]]) -> Self: ...
...
class McpTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'mcp_tool', 'mcp_session_manager', 'progress_callback', 'auth_credential', 'header_provider', 'auth_scheme', 'require_confirmation'}
...
class McpToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'progress_callback', 'auth_credential', 'header_provider', 'tool_name_prefix', 'errlog', 'auth_scheme', 'use_mcp_resources', 'require_confirmation', 'connection_params', 'tool_filter'}
...
class OpenAPIToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'ssl_verify', 'auth_credential', 'header_provider', 'spec_str_type', 'tool_name_prefix', 'spec_dict', 'auth_scheme', 'credential_key', 'tool_filter', 'spec_str'}
    def __init__(self) -> None: ...
...
class RestApiTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'ssl_verify', 'description', 'auth_credential', 'should_parse_operation', 'header_provider', 'endpoint', 'name', 'auth_scheme', 'operation', 'credential_key'}
...
class ToolboxToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'auth_token_getters', 'server_url', 'tool_names', 'additional_headers', 'toolset_name', 'credentials', 'bound_params'}
...
class VertexAiSearchTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'filter', 'data_store_specs', 'search_engine_id', 'bypass_multi_tools_limit', 'data_store_id', 'max_results'}
    def __init__(self) -> None: ...
    def data_store_id(self, value: Optional[str]) -> Self: ...
    def data_store_specs(self, value: Optional[list[types.VertexAISearchDataStoreSpec]]) -> Self: ...
    def search_engine_id(self, value: Optional[str]) -> Self: ...
