...
Timestamp: 2026-02-20T08:01:06.341624+00:00"""
...
from google.adk.tools.api_registry import ToolPredicate
from google.adk.tools.apihub_tool.apihub_toolset import APIHubClient
from google.adk.tools.apihub_tool.apihub_toolset import APIHubToolset as _ADK_APIHubToolset
from google.adk.tools.apihub_tool.apihub_toolset import RestApiTool
...
from google.adk.tools.bigtable.bigtable_toolset import BigtableToolSettings
...
from google.adk.tools.mcp_tool.mcp_toolset import McpToolset as _ADK_McpToolset
from google.adk.tools.openapi_tool.openapi_spec_parser.openapi_spec_parser import Operation
...
from google.adk.tools.spanner.query_tool import SpannerToolSettings
...
class ActiveStreamingTool(BuilderBase):
    ...
    def task(self, value: Task | None) -> Self: ...
...
class APIHubToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'apihub_client', 'description', 'name', 'tool_filter', 'auth_scheme', 'auth_credential', 'service_account_json', 'lazy_load_spec', 'apihub_resource_name', 'access_token'}
...
class ApplicationIntegrationToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'connection', 'tool_instructions', 'auth_scheme', 'location', 'auth_credential', 'integration', 'tool_name_prefix', 'triggers', 'service_account_json', 'tool_filter', 'entity_operations', 'connection_template_override', 'actions', 'project'}
...
class IntegrationConnectorTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'description', 'name', 'connection_name', 'connection_service_name', 'action', 'auth_scheme', 'entity', 'rest_api_tool', 'auth_credential', 'connection_host', 'operation'}
...
class DiscoveryEngineSearchTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'data_store_id', 'filter', 'max_results', 'search_engine_id', 'data_store_specs'}
    def __init__(self) -> None: ...
    def data_store_id(self, value: str | None) -> Self: ...
    def data_store_specs(self, value: list[types.VertexAISearchDataStoreSpec] | None) -> Self: ...
...
class GoogleApiTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'client_id', 'rest_api_tool', 'additional_headers', 'client_secret', 'service_account'}
...
class GoogleApiToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'client_id', 'tool_filter', 'api_version', 'api_name', 'tool_name_prefix', 'additional_headers', 'client_secret', 'service_account'}
...
class CalendarToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'client_id', 'client_secret', 'tool_name_prefix', 'tool_filter', 'service_account'}
    def __init__(self) -> None: ...
    def client_id(self, value: str | None) -> Self: ...
    def client_secret(self, value: str | None) -> Self: ...
    def tool_filter(self, value: ToolPredicate | list[str] | None) -> Self: ...
...
class McpTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'header_provider', 'progress_callback', 'mcp_tool', 'auth_scheme', 'auth_credential', 'require_confirmation', 'mcp_session_manager'}
...
class McpToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'header_provider', 'progress_callback', 'auth_scheme', 'auth_credential', 'tool_name_prefix', 'errlog', 'tool_filter', 'require_confirmation', 'connection_params', 'use_mcp_resources'}
...
class OpenAPIToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'header_provider', 'auth_scheme', 'spec_dict', 'auth_credential', 'spec_str', 'ssl_verify', 'credential_key', 'tool_name_prefix', 'spec_str_type', 'tool_filter'}
    def __init__(self) -> None: ...
...
class RestApiTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'description', 'header_provider', 'name', 'endpoint', 'auth_scheme', 'ssl_verify', 'auth_credential', 'should_parse_operation', 'credential_key', 'operation'}
...
class ToolboxToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'credentials', 'auth_token_getters', 'bound_params', 'additional_headers', 'tool_names', 'toolset_name', 'server_url'}
    ...
    def credentials(self, value: CredentialConfig | None) -> Self: ...
...
class VertexAiSearchTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'data_store_id', 'filter', 'bypass_multi_tools_limit', 'max_results', 'search_engine_id', 'data_store_specs'}
    def __init__(self) -> None: ...
    def data_store_id(self, value: str | None) -> Self: ...
    def data_store_specs(self, value: list[types.VertexAISearchDataStoreSpec] | None) -> Self: ...
    def search_engine_id(self, value: str | None) -> Self: ...
