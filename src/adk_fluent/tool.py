...
class APIHubToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'description', 'apihub_resource_name', 'name', 'auth_scheme', 'apihub_client', 'access_token', 'tool_filter', 'auth_credential', 'service_account_json', 'lazy_load_spec'}
...
class ApplicationIntegrationToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'tool_name_prefix', 'project', 'auth_scheme', 'location', 'connection_template_override', 'actions', 'entity_operations', 'tool_filter', 'auth_credential', 'triggers', 'tool_instructions', 'service_account_json', 'integration', 'connection'}
...
class IntegrationConnectorTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'description', 'rest_api_tool', 'name', 'auth_scheme', 'connection_name', 'action', 'connection_host', 'auth_credential', 'operation', 'connection_service_name', 'entity'}
...
class BaseAuthenticatedTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'description', 'auth_config', 'name', 'response_for_auth_required'}
...
class ComputerUseTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'func', 'virtual_screen_size', 'screen_size'}
...
class DiscoveryEngineSearchTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'search_engine_id', 'data_store_specs', 'max_results', 'data_store_id', 'filter'}
...
class GoogleApiTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'client_secret', 'rest_api_tool', 'service_account', 'client_id', 'additional_headers'}
...
class GoogleApiToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'client_secret', 'api_name', 'service_account', 'tool_name_prefix', 'client_id', 'tool_filter', 'additional_headers', 'api_version'}
...
class CalendarToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'client_secret', 'tool_name_prefix', 'service_account', 'client_id', 'tool_filter'}
...
class McpTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'require_confirmation', 'header_provider', 'mcp_session_manager', 'auth_scheme', 'progress_callback', 'auth_credential', 'mcp_tool'}
...
class McpToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'require_confirmation', 'header_provider', 'tool_name_prefix', 'use_mcp_resources', 'auth_scheme', 'errlog', 'connection_params', 'progress_callback', 'tool_filter', 'auth_credential'}
...
class OpenAPIToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'header_provider', 'tool_name_prefix', 'auth_scheme', 'spec_dict', 'credential_key', 'ssl_verify', 'tool_filter', 'auth_credential', 'spec_str', 'spec_str_type'}
...
class RestApiTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'description', 'should_parse_operation', 'header_provider', 'name', 'auth_scheme', 'endpoint', 'credential_key', 'ssl_verify', 'auth_credential', 'operation'}
...
class ToolboxToolset(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'credentials', 'auth_token_getters', 'tool_names', 'toolset_name', 'additional_headers', 'server_url', 'bound_params'}
...
class VertexAiSearchTool(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'search_engine_id', 'data_store_specs', 'max_results', 'data_store_id', 'filter', 'bypass_multi_tools_limit'}
