...
Timestamp: 2026-02-20T05:48:32.359377+00:00"""
...
class Runner(BuilderBase):
    ...
    _CALLBACK_ALIASES: dict[str, str] = {}
    _ADDITIVE_FIELDS: set[str] = set()
    _KNOWN_PARAMS: set[str] = {'session_service', 'plugin_close_timeout', 'agent', 'plugins', 'credential_service', 'memory_service', 'app_name', 'artifact_service', 'auto_create_session', 'app'}
