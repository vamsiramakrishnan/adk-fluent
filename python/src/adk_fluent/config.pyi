...
Generated from google-adk 1.25.0 (manifest 31517b2fdce8)"""
...
class BaseAgentConfig(BuilderBase):
    ...
    def transfer_to(self, value: _ADK_AgentRefConfig) -> Self: ...
...
class LoopAgentConfig(BuilderBase):
    ...
    def step(self, value: _ADK_AgentRefConfig) -> Self: ...
    def before_agent_callback(self, value: _ADK_CodeConfig) -> Self: ...
    def after_agent_callback(self, value: _ADK_CodeConfig) -> Self: ...
...
class ParallelAgentConfig(BuilderBase):
    ...
    def before_agent_callbacks(self, value: list[_ADK_CodeConfig] | None) -> Self: ...
    def after_agent_callbacks(self, value: list[_ADK_CodeConfig] | None) -> Self: ...
    def branch(self, value: _ADK_AgentRefConfig) -> Self: ...
    def step(self, value: _ADK_AgentRefConfig) -> Self: ...
    def before_agent_callback(self, value: _ADK_CodeConfig) -> Self: ...
    def after_agent_callback(self, value: _ADK_CodeConfig) -> Self: ...
...
class RunConfig(BuilderBase):
    ...
    def __init__(self) -> None: ...
    def input_audio_transcribe(
        self, value: AudioTranscriptionConfig | None
    ) -> Self: ...
    def output_audio_transcribe(
        self, value: AudioTranscriptionConfig | None
    ) -> Self: ...
    ...
    def tool_thread_pool_config(
        self, value: _ADK_ToolThreadPoolConfig | None
    ) -> Self: ...
...
class AgentSimulatorConfig(BuilderBase):
    ...
    def tool_simulation_configs(
        self, value: list[_ADK_ToolSimulationConfig]
    ) -> Self: ...
