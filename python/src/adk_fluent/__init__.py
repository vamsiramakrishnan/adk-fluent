...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "RegressionResult": ("._eval", "RegressionResult"),
    "MetricDelta": ("._eval", "MetricDelta"),
    "RegressionError": ("._eval", "RegressionError"),
    ...
    "A2UIError": ("._exceptions", "A2UIError"),
    "A2UINotInstalled": ("._exceptions", "A2UINotInstalled"),
    "A2UISurfaceError": ("._exceptions", "A2UISurfaceError"),
    "A2UIBindingError": ("._exceptions", "A2UIBindingError"),
    "G": ("._guards", "G"),
    ...
    "stream_from_cursor": ("._helpers", "stream_from_cursor"),
    ...
    "GuardFired": ("._harness", "GuardFired"),
    "EvalEvent": ("._harness", "EvalEvent"),
    "EffectRecorded": ("._harness", "EffectRecorded"),
    ...
    "AgentToken": ("._harness", "AgentToken"),
    "TokenRegistry": ("._harness", "TokenRegistry"),
    ...
    "EffectCache": ("._harness", "EffectCache"),
    "EffectEntry": ("._harness", "EffectEntry"),
    ...
    "active_bus": ("._harness._event_bus", "active_bus"),
    "emit": ("._harness._event_bus", "emit"),
    "use_bus": ("._harness._event_bus", "use_bus"),
    ...
    "ApprovalRequest": ("._permissions", "ApprovalRequest"),
    "ApprovalVerdict": ("._permissions", "ApprovalVerdict"),
    "InteractiveApprovalHandler": ("._permissions", "InteractiveApprovalHandler"),
    "Responder": ("._permissions", "Responder"),
    "make_permission_callback": ("._permissions._callback", "make_permission_callback"),
    "R": ("._reactor", "R"),
    "Reactor": ("._reactor", "Reactor"),
    "ReactorPlugin": ("._reactor", "ReactorPlugin"),
    "ReactorRule": ("._reactor", "ReactorRule"),
    "RuleSpec": ("._reactor", "RuleSpec"),
    "Signal": ("._reactor", "Signal"),
    "SignalPredicate": ("._reactor", "SignalPredicate"),
    "SignalRegistry": ("._reactor", "SignalRegistry"),
    "computed": ("._reactor", "computed"),
    "default_registry": ("._reactor", "default_registry"),
    "reaction": ("._reactor", "reaction"),
    "track_reads": ("._reactor", "track_reads"),
    "current_tracker": ("._reactor._tracking", "current_tracker"),
    "ChainBackend": ("._session", "ChainBackend"),
    "InMemoryBackend": ("._session", "InMemoryBackend"),
    "JsonlBackend": ("._session", "JsonlBackend"),
    "NullBackend": ("._session", "NullBackend"),
    "TapeBackend": ("._session", "TapeBackend"),
    "active_cache": ("._session", "active_cache"),
    "use_cache": ("._session", "use_cache"),
    "AdkSubagentRunner": ("._subagents", "AdkSubagentRunner"),
    ...
    "CheckpointAnnotation": (".compile.passes", "CheckpointAnnotation"),
    ...
    "GeminiProvider": (".compute", "GeminiProvider"),
    "OpenAIProvider": (".compute", "OpenAIProvider"),
    "AnthropicProvider": (".compute", "AnthropicProvider"),
    "OllamaProvider": (".compute", "OllamaProvider"),
    "provider_from_model": (".compute", "provider_from_model"),
