...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "PermissionPolicy": ("._permissions", "PermissionPolicy"),
    "PermissionDecision": ("._permissions", "PermissionDecision"),
    "PermissionBehavior": ("._permissions", "PermissionBehavior"),
    "PermissionMode": ("._permissions", "PermissionMode"),
    "PermissionPlugin": ("._permissions", "PermissionPlugin"),
    "PermissionHandler": ("._permissions", "PermissionHandler"),
    "ApprovalMemory": ("._permissions", "ApprovalMemory"),
    "ALL_MODES": ("._permissions", "ALL_MODES"),
    "DEFAULT_MUTATING_TOOLS": ("._permissions", "DEFAULT_MUTATING_TOOLS"),
    "DEFAULT_READ_ONLY_TOOLS": ("._permissions", "DEFAULT_READ_ONLY_TOOLS"),
    ...
    "ForkManager": ("._session", "ForkManager"),
    "Branch": ("._session", "Branch"),
    "UsageTracker": ("._usage", "UsageTracker"),
    "UsagePlugin": ("._usage", "UsagePlugin"),
    "TurnUsage": ("._usage", "TurnUsage"),
    "AgentUsage": ("._usage", "AgentUsage"),
    "CostTable": ("._usage", "CostTable"),
    "ModelRate": ("._usage", "ModelRate"),
