...
from adk_fluent._base_introspection import IntrospectionMixin
from adk_fluent._base_operators import OperatorsMixin
from adk_fluent._base_serialization import SerializationMixin
...
class BuilderBase(OperatorsMixin, IntrospectionMixin, SerializationMixin):
    ...
    # ------------------------------------------------------------------
    # Task 3: Operator Composition (>>, |, *, @, //) — OperatorsMixin
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # Task 4: Introspection — provided by IntrospectionMixin
    # (explain / inspect / _explain_plain / _build_rich_tree / _explain_json)
    # ------------------------------------------------------------------

    # ------------------------------------------------------------------
    # Task 5: Serialization — provided by SerializationMixin
    # (to_dict / from_dict / to_yaml / from_yaml / from_native)
    # ------------------------------------------------------------------
