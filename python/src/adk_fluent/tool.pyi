...
from typing import Any, Literal, Self, TextIO, Union
...
from google.adk.tools.base_toolset import BaseToolset as _ADK_BaseToolset, ToolPredicate
...
class BaseAuthenticatedTool(BuilderBase):
    ...
    def response_for_auth_required(
        self, value: dict[str, Any] | str | None
    ) -> Self: ...
...
class DiscoveryEngineSearchTool(BuilderBase):
    ...
    def data_store_specs(
        self, value: list[VertexAISearchDataStoreSpec] | None
    ) -> Self: ...
...
class ToolboxToolset(BuilderBase):
    ...
    def auth_token_getters(
        self, value: Mapping[str, Callable[[], str]] | None
    ) -> Self: ...
    def bound_params(
