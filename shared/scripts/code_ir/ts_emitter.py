...
_INLINE_HELPERS: dict[str, object] = {
    ...
    "_show_agent": [("config", "_visibility", '"reveal"')],
    ...
    "_show_pipeline": [("config", "_visibility", '"reveal"')],
    "_hide_pipeline": [("config", "_visibility", '"hide"')],
    "_show_fanout": [("config", "_visibility", '"reveal"')],
    "_hide_fanout": [("config", "_visibility", '"hide"')],
    "_show_loop": [("config", "_visibility", '"reveal"')],
